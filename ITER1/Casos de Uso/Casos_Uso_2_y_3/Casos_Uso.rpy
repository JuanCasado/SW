...
{ IProject 
	...
	- _myState = 8192;
	- _name = "Casos_Uso";
	- _objectCreation = "12315742254201819217471012";
	- _umlDependencyID = "2596";
	- _lastID = 4;
	...
	- Diagrams = { IRPYRawContainer 
		...
		{ IDiagram 
			...
			- _myState = 8192;
			- _name = "Model1";
			- _objectCreation = "12329642254201819203571012";
	...
	- UCDiagrams = { IRPYRawContainer 
		...
		{ IUCDiagram 
			...
			- _objectCreation = "12329662254201819203551012";
			- _umlDependencyID = "3630";
			- _lastModifiedTime = "10.22.2018::14:37:30";
			- _graphicChart = { CGIClassChart 
				...
				{ CGIBasicClass 
					...
					- m_drawBehavior = 2056;
					- m_transform = 0.0947741 0 0 0.0560224 734.19 929.056 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
				...
				{ CGIBasicClass 
					...
					- m_drawBehavior = 2056;
					- m_transform = 0.0965456 0 0 0.0429505 1061.19 871.043 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
				...
				{ CGIBasicClass 
					...
					- m_drawBehavior = 2056;
					- m_transform = 0.0956599 0 0 0.0485528 1110.19 954.049 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
				...
				{ CGIBasicClass 
					...
					- m_drawBehavior = 2056;
					- m_transform = 0.0947741 0 0 0.054155 1064.19 1039.05 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
				...
				{ CGIInheritance 
					- _id = GUID afd9095f-a21f-4998-bf7f-25bb714d47ba;
					- _properties = { IPropertyContainer 
						- Subjects = { IRPYRawContainer 
							- size = 1;
							- value = 
					...
					- m_drawBehavior = 8;
					- m_bIsPreferencesInitialized = 1;
					- m_pSource = GUID 3f511ea1-e433-488c-b463-c756073b9038;
					- m_sourceType = 'F';
					- m_pTarget = GUID 4ce624f1-0542-4120-b0ab-b8133445d25d;
					- m_targetType = 'T';
					- m_direction = ' ';
					- m_rpn = { CGIText 
						- m_str = "extend";
				...
				{ CGIInheritance 
					- _id = GUID 3fdb904e-1a14-43e3-ae16-93e8bd19efa8;
					- _properties = { IPropertyContainer 
						- Subjects = { IRPYRawContainer 
							- size = 1;
							- value = 
					...
					- m_pSource = GUID 3f511ea1-e433-488c-b463-c756073b9038;
					- m_sourceType = 'F';
					- m_pTarget = GUID e69c552c-7da4-4dfc-9b43-24f701b9df63;
					- m_targetType = 'T';
					- m_direction = ' ';
					- m_rpn = { CGIText 
						- m_str = "include";
				...
				{ CGIInheritance 
					- _id = GUID 70f2766b-411a-4849-bad1-ea8e7d0b10b8;
					- _properties = { IPropertyContainer 
						- Subjects = { IRPYRawContainer 
							- size = 1;
							- value = 
					...
					- m_drawBehavior = 8;
					- m_bIsPreferencesInitialized = 1;
					- m_pSource = GUID e69c552c-7da4-4dfc-9b43-24f701b9df63;
					- m_sourceType = 'F';
					- m_pTarget = GUID c7cea9de-0537-4bd5-9e34-6616cb43e307;
					- m_targetType = 'T';
					- m_direction = ' ';
					- m_rpn = { CGIText 
						- m_str = "extend";
				...
				{ CGIInheritance 
					- _id = GUID b03194d9-95a3-427a-a6c4-d3a55658d0fa;
					- _properties = { IPropertyContainer 
						- Subjects = { IRPYRawContainer 
							- size = 1;
							- value = 
					...
					- m_pSource = GUID e69c552c-7da4-4dfc-9b43-24f701b9df63;
					- m_sourceType = 'F';
					- m_pTarget = GUID 5ecc1cfc-ea37-442b-b96e-1aa1877b628f;
					- m_targetType = 'T';
					- m_direction = ' ';
					- m_rpn = { CGIText 
						- m_str = "extend";
				...
				{ CGIBasicClass 
					- _id = GUID 3f511ea1-e433-488c-b463-c756073b9038;
					- m_type = 125;
					- m_pModelObject = { IHandle 
						- _m2Class = "IUseCase";
						- _filename = "Default.sbs";
					...
					- m_drawBehavior = 2056;
					- m_transform = 0.0965456 0 0 0.047619 729.193 748.048 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
				...
				{ CGIBasicClass 
					- _id = GUID 4ce624f1-0542-4120-b0ab-b8133445d25d;
					- m_type = 125;
					- m_pModelObject = { IHandle 
						- _m2Class = "IUseCase";
						- _filename = "Default.sbs";
					...
					- m_drawBehavior = 2056;
					- m_transform = 0.0806023 0 0 0.0550887 1013.16 653.055 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
				...
				{ CGIBasicClass 
					- _id = GUID 5ecc1cfc-ea37-442b-b96e-1aa1877b628f;
					- m_type = 125;
					- m_pModelObject = { IHandle 
						- _m2Class = "IUseCase";
						- _filename = "Default.sbs";
					...
					- m_drawBehavior = 2056;
					- m_transform = 0.085031 0 0 0.0532213 1078.17 733.053 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
				...
				{ CGIBasicClass 
					- _id = GUID c7cea9de-0537-4bd5-9e34-6616cb43e307;
					- m_type = 125;
					- m_pModelObject = { IHandle 
						- _m2Class = "IUseCase";
						- _filename = "Default.sbs";
					...
					- m_drawBehavior = 2056;
					- m_transform = 0.0779451 0 0 0.0448179 1086.16 814.045 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
				...
				{ CGIBasicClass 
					- _id = GUID e69c552c-7da4-4dfc-9b43-24f701b9df63;
					- m_type = 125;
					- m_pModelObject = { IHandle 
						- _m2Class = "IUseCase";
						- _filename = "Default.sbs";
					...
					- m_drawBehavior = 2056;
					- m_transform = 0.0965456 0 0 0.0504202 879.193 776.05 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
				...
				{ CGIInheritance 
					- _id = GUID 0040ff85-2937-45fb-b9bb-0c13cde97d4d;
					- _properties = { IPropertyContainer 
						- Subjects = { IRPYRawContainer 
							- size = 1;
							- value = 
					...
					- m_pModelObject = { IHandle 
						...
						- _subsystem = "Default";
						- _class = "Identificaci\ón";
						- _name = "Gestion de Clientes_1";
						- _id = GUID 43efb035-c5fa-4229-8cbf-632cfd81e771;
					}
					- m_pParent = ;
					- m_name = { CGIText 
						- m_str = "Gestion de Clientes_1";
						- m_style = "Arial" 10 0 0 0 1 ;
						- m_color = { IColor 
							- m_fgColor = 0;
							- m_bgColor = 0;
					...
					- m_pSource = GUID c93ebc0b-75b2-47f7-a737-fb1a8a3e32cf;
					- m_sourceType = 'F';
					- m_pTarget = GUID 3f511ea1-e433-488c-b463-c756073b9038;
					- m_targetType = 'T';
					- m_direction = ' ';
					- m_rpn = { CGIText 
						- m_str = "include";
					...
					- m_anglePoint2 = 0 0 ;
					- m_line_style = 0;
					- m_SourcePort = 943 222 ;
					- m_TargetPort = 205 524 ;
					- m_ShowName = 0;
					- m_ShowStereotype = 1;
				}
				{ CGIAssociationEnd 
		...
		{ IUCDiagram 
			...
			- _objectCreation = "12329682254201819203531012";
			- _umlDependencyID = "4530";
...
";
			...
			- _lastModifiedTime = "10.22.2018::17:54:10";
			- _graphicChart = { CGIClassChart 
				...
				{ CGIBasicClass 
					...
					- m_drawBehavior = 2056;
					- m_transform = 0.107174 0 0 0.0550887 447.214 258.055 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
				...
				{ CGIBasicClass 
					...
					- m_drawBehavior = 2056;
					- m_transform = 0.106289 0 0 0.060691 630.213 187.061 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
				...
				{ CGIBasicClass 
					...
					- m_drawBehavior = 2056;
					- m_transform = 0.127546 0 0 0.0597572 631.255 294.06 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
				...
				{ CGIBasicClass 
					- _id = GUID 96362460-99d8-41b0-bc85-68c28dc2b32c;
					- m_type = 125;
					- m_pModelObject = { IHandle 
						- _m2Class = "IUseCase";
						- _filename = "Default.sbs";
					...
					- m_drawBehavior = 2056;
					- m_transform = 0.110717 0 0 0.0364146 249.221 266.036 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
				...
				{ CGIInheritance 
					- _id = GUID 1ad37431-136a-4bb8-87a1-c7de1f9163ef;
					- _properties = { IPropertyContainer 
						- Subjects = { IRPYRawContainer 
							- size = 1;
							- value = 
					...
					- m_pModelObject = { IHandle 
						...
						- _id = GUID 8d552e3e-f34c-4e7f-bad7-afe0b356f3df;
					}
					- m_pParent = ;
					- m_name = { CGIText 
					...
					- m_drawBehavior = 8;
					- m_bIsPreferencesInitialized = 1;
					- m_pSource = GUID 96362460-99d8-41b0-bc85-68c28dc2b32c;
					- m_sourceType = 'F';
					...
					- m_anglePoint2 = 0 0 ;
					- m_line_style = 0;
					- m_SourcePort = 1001 548 ;
					- m_TargetPort = 315 544 ;
					- m_ShowName = 0;
					- m_ShowStereotype = 1;
				}
				{ CGIAssociationEnd 
					- _id = GUID f32d5b78-43a9-4e09-8dd2-30447fb10110;
					- _properties = { IPropertyContainer 
						- Subjects = { IRPYRawContainer 
							- size = 1;
							- value = 
					...
					- m_pModelObject = { IHandle 
						...
						- _name = "itsIdentificaci\ón_1";
						- _id = GUID d058ff1c-4eef-428e-a4a9-09ed412029b4;
					}
					- m_pParent = ;
					- m_name = { CGIText 
						- m_str = "";
					...
					- m_sourceType = 'F';
					- m_pTarget = GUID 96362460-99d8-41b0-bc85-68c28dc2b32c;
					- m_targetType = 'T';
					- m_direction = ' ';
					- m_rpn = { CGIText 
						- m_str = "";
					...
					- m_anglePoint2 = 0 0 ;
					- m_line_style = 0;
					- m_SourcePort = 645 758 ;
					- m_TargetPort = 603 521 ;
					- m_pInverseModelObject = { IAssociationEndHandle 
						- _m2Class = "IAssociationEnd";
						- _filename = "Default.sbs";
						- _subsystem = "Default";
						...
						- _id = GUID c157c532-826d-49e8-9893-6392cb0bc8ec;
					}
					- m_pInstance = { IObjectLinkHandle 
						- _m2Class = "";
					}
		...
		{ IUCDiagram 
			...
			- _objectCreation = "12329702254201819203511012";
		...
		{ IUCDiagram 
			...
			- _objectCreation = "12329722254201819203491012";
		...
		{ IUCDiagram 
			...
			- _objectCreation = "12329742254201819203471012";
			- _umlDependencyID = "3216";
			...
			- _graphicChart = { CGIClassChart 
				...
				{ CGIBasicClass 
					...
					- m_drawBehavior = 2056;
					- m_transform = 0.0938884 0 0 0.0588235 683.188 73.0588 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
